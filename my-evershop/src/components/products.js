...
<div className="text-sm flex justify-center font-semibold gap-2 py-9"> 
    ...
    {Array.from({length:pageCount},(_,index)=>(
            ...
            <div className="border border-gray-400 hover:cursor-pointer text-gray-500 rounded-full p-3 relative items-center justify-center flex"> <span className="absolute" >3</span></div>
            <div className="border border-gray-400 hover:cursor-pointer text-gray-500 rounded-full p-3 relative items-center justify-center flex"> <span className="absolute" >4</span></div>
             */}
